...
void Write16x1(umm Count, void* Dst);

static test_config Tests[] = 
{
    { "Mem 4KiB",   &Write16x1, KiB(4),     MemoryType_Host },
    { "Mem 8KiB",   &Write16x1, KiB(8),     MemoryType_Host },
    { "Mem 16KiB",  &Write16x1, KiB(16),    MemoryType_Host },
    { "Mem 32KiB",  &Write16x1, KiB(32),    MemoryType_Host },
    { "Mem 64KiB",  &Write16x1, KiB(64),    MemoryType_Host },
    { "Mem 128KiB", &Write16x1, KiB(128),   MemoryType_Host },
    { "Mem 256KiB", &Write16x1, KiB(256),   MemoryType_Host },
    { "Mem 512KiB", &Write16x1, KiB(512),   MemoryType_Host },
    { "Mem 1MiB",   &Write16x1, MiB(1),     MemoryType_Host },
    { "Mem 2MiB",   &Write16x1, MiB(2),     MemoryType_Host },
    { "Mem 4MiB",   &Write16x1, MiB(4),     MemoryType_Host },
    { "Mem 8MiB",   &Write16x1, MiB(8),     MemoryType_Host },
    { "Mem 16MiB",  &Write16x1, MiB(16),    MemoryType_Host },
    { "Mem 32MiB",  &Write16x1, MiB(32),    MemoryType_Host },
    { "Mem 64MiB",  &Write16x1, MiB(64),    MemoryType_Host },
    { "Bar 4KiB",   &Write16x1, KiB(4),     MemoryType_BAR },
    { "Bar 8KiB",   &Write16x1, KiB(8),     MemoryType_BAR },
    { "Bar 16KiB",  &Write16x1, KiB(16),    MemoryType_BAR },
    { "Bar 32KiB",  &Write16x1, KiB(32),    MemoryType_BAR },
    { "Bar 64KiB",  &Write16x1, KiB(64),    MemoryType_BAR },
    { "Bar 128KiB", &Write16x1, KiB(128),   MemoryType_BAR },
    { "Bar 256KiB", &Write16x1, KiB(256),   MemoryType_BAR },
    { "Bar 512KiB", &Write16x1, KiB(512),   MemoryType_BAR },
    { "Bar 1MiB",   &Write16x1, MiB(1),     MemoryType_BAR },
    { "Bar 2MiB",   &Write16x1, MiB(2),     MemoryType_BAR },
    { "Bar 4MiB",   &Write16x1, MiB(4),     MemoryType_BAR },
    { "Bar 8MiB",   &Write16x1, MiB(8),     MemoryType_BAR },
    { "Bar 16MiB",  &Write16x1, MiB(16),    MemoryType_BAR },
    { "Bar 32MiB",  &Write16x1, MiB(32),    MemoryType_BAR },
    { "Bar 64MiB",  &Write16x1, MiB(64),    MemoryType_BAR },
};
